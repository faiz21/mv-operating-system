...
import { renderGovernanceAuthorityMatrix } from "./views/governance-authority-matrix.ts";
import { renderGovernanceConstitution } from "./views/governance-constitution.ts";
  ...
  return html`
    ...
    >
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "constitution" ? renderGovernanceConstitution() : nothing}

        ${state.tab === "authorityMatrix" ? renderGovernanceAuthorityMatrix() : nothing}
